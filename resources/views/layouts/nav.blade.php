    ...
    <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                <li class="breadcrumb-item text-sm"><a class="opacity-5 text-white" href="javascript:;">CHIMS</a></li>
                <li class="breadcrumb-item text-sm text-white active" aria-current="page">ระบบบริหารข้อมูลหนี้ระหว่างโรงพยาบาล</li>
            </ol>
        </nav>
