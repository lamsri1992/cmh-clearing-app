...
<aside class="sidenav bg-white navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-4 "
    ...
    <div class="sidenav-header">
        ...
        <a class="navbar-brand m-0" href="#" target="_blank">
            ...
            <span class="ms-1 font-weight-bold">CMH - CHIMS</span>
        </a>
    </div>
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
        <ul class="navbar-nav">
            ...
            {{-- <li class="nav-item">
                <a class="nav-link {{ (request()->is('process*')) ? 'active' : '' }}" href="{{ url('process') }}">
                    <div
                        class="icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
                        <i class="fa-solid fa-cloud-arrow-down text-dark text-sm opacity-10"></i>
                    </div>
